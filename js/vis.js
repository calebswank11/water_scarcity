//--VIS.JS--//
  ...
  d3.json("json/world-countries.json", function(collection) {
    ...
    //Append country title to path element in DOM
    feature.append("#canvas_glove_svg:title")
        .text(function(d) { return d.properties.name; });

    //Append country waste number to path element in DOM
    feature.append("#canvas_glove_svg:waste")
        .text(function(d) { return d.waste; });
